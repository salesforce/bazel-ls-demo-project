...
public abstract class Foo2<Y> extends module1963_public_tests_more.a.Foo0<Y> implements module1963_public_tests_more.a.IFoo2<Y> {
	 ...
	 public Y get() {
	 	 return (Y)module1963_public_tests_more.a.Foo0.getInstance().get();
	 }
	 ...
	 public Y call() throws Exception {
	 	 return (Y)module1963_public_tests_more.a.Foo0.getInstance().call();
	 }
}
