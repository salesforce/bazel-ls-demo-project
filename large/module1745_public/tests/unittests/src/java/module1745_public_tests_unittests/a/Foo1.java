...
public abstract class Foo1<N> extends module1745_public_tests_unittests.a.Foo0<N> implements module1745_public_tests_unittests.a.IFoo1<N> {
	 ...
	 public N get() {
	 	 return (N)module1745_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public N call() throws Exception {
	 	 return (N)module1745_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
