...
public abstract class Foo2<K> extends module0527_public.a.Foo0<K> implements module0527_public.a.IFoo2<K> {
	 ...
	 public K get() {
	 	 return (K)module0527_public.a.Foo0.getInstance().get();
	 }
	 ...
	 public K call() throws Exception {
	 	 return (K)module0527_public.a.Foo0.getInstance().call();
	 }
}
