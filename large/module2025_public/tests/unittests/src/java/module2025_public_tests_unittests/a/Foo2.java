...
public abstract class Foo2<K> extends module2025_public_tests_unittests.a.Foo0<K> implements module2025_public_tests_unittests.a.IFoo2<K> {
	 ...
	 public K get() {
	 	 return (K)module2025_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public K call() throws Exception {
	 	 return (K)module2025_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
