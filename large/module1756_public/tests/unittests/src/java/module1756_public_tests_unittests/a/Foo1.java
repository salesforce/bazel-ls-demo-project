...
public abstract class Foo1<J> extends module1756_public_tests_unittests.a.Foo0<J> implements module1756_public_tests_unittests.a.IFoo1<J> {
	 ...
	 public J get() {
	 	 return (J)module1756_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public J call() throws Exception {
	 	 return (J)module1756_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
