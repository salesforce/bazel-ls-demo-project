...
public abstract class Foo1<Z> extends module1099_public_tests_unittests.a.Foo0<Z> implements module1099_public_tests_unittests.a.IFoo1<Z> {
	 ...
	 public Z get() {
	 	 return (Z)module1099_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public Z call() throws Exception {
	 	 return (Z)module1099_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
