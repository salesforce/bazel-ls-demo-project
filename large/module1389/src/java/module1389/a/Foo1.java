...
public abstract class Foo1<T> extends module1389.a.Foo0<T> implements module1389.a.IFoo1<T> {
	 ...
	 public T get() {
	 	 return (T)module1389.a.Foo0.getInstance().get();
	 }
	 ...
	 public T call() throws Exception {
	 	 return (T)module1389.a.Foo0.getInstance().call();
	 }
}
