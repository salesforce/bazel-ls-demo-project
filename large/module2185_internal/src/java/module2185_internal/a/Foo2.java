...
public abstract class Foo2<C> extends module2185_internal.a.Foo0<C> implements module2185_internal.a.IFoo2<C> {
	 ...
	 public C get() {
	 	 return (C)module2185_internal.a.Foo0.getInstance().get();
	 }
	 ...
	 public C call() throws Exception {
	 	 return (C)module2185_internal.a.Foo0.getInstance().call();
	 }
}
