...
public abstract class Foo2<O> extends module2013_public_tests_unittests.a.Foo0<O> implements module2013_public_tests_unittests.a.IFoo2<O> {
	 ...
	 public O get() {
	 	 return (O)module2013_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public O call() throws Exception {
	 	 return (O)module2013_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
