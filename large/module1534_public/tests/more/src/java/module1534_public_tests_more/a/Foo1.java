...
public abstract class Foo1<V> extends module1534_public_tests_more.a.Foo0<V> implements module1534_public_tests_more.a.IFoo1<V> {
	 ...
	 public V get() {
	 	 return (V)module1534_public_tests_more.a.Foo0.getInstance().get();
	 }
	 ...
	 public V call() throws Exception {
	 	 return (V)module1534_public_tests_more.a.Foo0.getInstance().call();
	 }
}
