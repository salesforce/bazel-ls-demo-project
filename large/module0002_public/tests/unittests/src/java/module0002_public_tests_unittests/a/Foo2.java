...
public abstract class Foo2<C> extends module0002_public_tests_unittests.a.Foo0<C> implements module0002_public_tests_unittests.a.IFoo2<C> {
	 ...
	 public C get() {
	 	 return (C)module0002_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public C call() throws Exception {
	 	 return (C)module0002_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
