...
public abstract class Foo1<V> extends module2006_public.a.Foo0<V> implements module2006_public.a.IFoo1<V> {
	 ...
	 public V get() {
	 	 return (V)module2006_public.a.Foo0.getInstance().get();
	 }
	 ...
	 public V call() throws Exception {
	 	 return (V)module2006_public.a.Foo0.getInstance().call();
	 }
}
