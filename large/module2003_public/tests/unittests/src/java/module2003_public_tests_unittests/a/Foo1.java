...
public abstract class Foo1<Z> extends module2003_public_tests_unittests.a.Foo0<Z> implements module2003_public_tests_unittests.a.IFoo1<Z> {
	 ...
	 public Z get() {
	 	 return (Z)module2003_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public Z call() throws Exception {
	 	 return (Z)module2003_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
