...
public abstract class Foo2<E> extends module1920_public_tests_unittests.a.Foo0<E> implements module1920_public_tests_unittests.a.IFoo2<E> {
	 ...
	 public E get() {
	 	 return (E)module1920_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public E call() throws Exception {
	 	 return (E)module1920_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
