...
public abstract class Foo2<K> extends module2097_public_tests_more.a.Foo0<K> implements module2097_public_tests_more.a.IFoo2<K> {
	 ...
	 public K get() {
	 	 return (K)module2097_public_tests_more.a.Foo0.getInstance().get();
	 }
	 ...
	 public K call() throws Exception {
	 	 return (K)module2097_public_tests_more.a.Foo0.getInstance().call();
	 }
}
