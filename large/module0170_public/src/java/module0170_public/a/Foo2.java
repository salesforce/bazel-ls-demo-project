...
public abstract class Foo2<C> extends module0170_public.a.Foo0<C> implements module0170_public.a.IFoo2<C> {
	 ...
	 public C get() {
	 	 return (C)module0170_public.a.Foo0.getInstance().get();
	 }
	 ...
	 public C call() throws Exception {
	 	 return (C)module0170_public.a.Foo0.getInstance().call();
	 }
}
