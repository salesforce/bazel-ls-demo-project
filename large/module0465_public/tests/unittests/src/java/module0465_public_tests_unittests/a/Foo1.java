...
public abstract class Foo1<R> extends module0465_public_tests_unittests.a.Foo0<R> implements module0465_public_tests_unittests.a.IFoo1<R> {
	 ...
	 public R get() {
	 	 return (R)module0465_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public R call() throws Exception {
	 	 return (R)module0465_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
