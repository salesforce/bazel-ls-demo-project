...
public abstract class Foo2<E> extends module2172_public_tests_unittests.a.Foo0<E> implements module2172_public_tests_unittests.a.IFoo2<E> {
	 ...
	 public E get() {
	 	 return (E)module2172_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public E call() throws Exception {
	 	 return (E)module2172_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
