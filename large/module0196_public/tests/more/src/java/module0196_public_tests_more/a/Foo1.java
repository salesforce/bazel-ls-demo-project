...
public abstract class Foo1<T> extends module0196_public_tests_more.a.Foo0<T> implements module0196_public_tests_more.a.IFoo1<T> {
	 ...
	 public T get() {
	 	 return (T)module0196_public_tests_more.a.Foo0.getInstance().get();
	 }
	 ...
	 public T call() throws Exception {
	 	 return (T)module0196_public_tests_more.a.Foo0.getInstance().call();
	 }
}
