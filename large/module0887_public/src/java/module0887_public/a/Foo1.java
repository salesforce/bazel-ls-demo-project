...
public abstract class Foo1<X> extends module0887_public.a.Foo0<X> implements module0887_public.a.IFoo1<X> {
	 ...
	 public X get() {
	 	 return (X)module0887_public.a.Foo0.getInstance().get();
	 }
	 ...
	 public X call() throws Exception {
	 	 return (X)module0887_public.a.Foo0.getInstance().call();
	 }
}
