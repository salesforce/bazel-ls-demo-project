...
public abstract class Foo1<T> extends module2248_public.a.Foo0<T> implements module2248_public.a.IFoo1<T> {
	 ...
	 public T get() {
	 	 return (T)module2248_public.a.Foo0.getInstance().get();
	 }
	 ...
	 public T call() throws Exception {
	 	 return (T)module2248_public.a.Foo0.getInstance().call();
	 }
}
