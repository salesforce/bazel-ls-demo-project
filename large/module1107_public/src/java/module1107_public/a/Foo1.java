...
public abstract class Foo1<V> extends module1107_public.a.Foo0<V> implements module1107_public.a.IFoo1<V> {
	 ...
	 public V get() {
	 	 return (V)module1107_public.a.Foo0.getInstance().get();
	 }
	 ...
	 public V call() throws Exception {
	 	 return (V)module1107_public.a.Foo0.getInstance().call();
	 }
}
