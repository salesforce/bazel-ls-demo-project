...
public abstract class Foo1<T> extends module0049_internal.a.Foo0<T> implements module0049_internal.a.IFoo1<T> {
	 ...
	 public T get() {
	 	 return (T)module0049_internal.a.Foo0.getInstance().get();
	 }
	 ...
	 public T call() throws Exception {
	 	 return (T)module0049_internal.a.Foo0.getInstance().call();
	 }
}
