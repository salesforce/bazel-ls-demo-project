...
public abstract class Foo1<X> extends module2229_public_tests_unittests.a.Foo0<X> implements module2229_public_tests_unittests.a.IFoo1<X> {
	 ...
	 public X get() {
	 	 return (X)module2229_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public X call() throws Exception {
	 	 return (X)module2229_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
