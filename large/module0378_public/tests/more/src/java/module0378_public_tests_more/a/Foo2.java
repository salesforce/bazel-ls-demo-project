...
public abstract class Foo2<C> extends module0378_public_tests_more.a.Foo0<C> implements module0378_public_tests_more.a.IFoo2<C> {
	 ...
	 public C get() {
	 	 return (C)module0378_public_tests_more.a.Foo0.getInstance().get();
	 }
	 ...
	 public C call() throws Exception {
	 	 return (C)module0378_public_tests_more.a.Foo0.getInstance().call();
	 }
}
