...
public abstract class Foo2<G> extends module1476_public_tests_unittests.a.Foo0<G> implements module1476_public_tests_unittests.a.IFoo2<G> {
	 ...
	 public G get() {
	 	 return (G)module1476_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public G call() throws Exception {
	 	 return (G)module1476_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
