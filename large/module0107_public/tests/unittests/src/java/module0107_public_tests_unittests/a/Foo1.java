...
public abstract class Foo1<P> extends module0107_public_tests_unittests.a.Foo0<P> implements module0107_public_tests_unittests.a.IFoo1<P> {
	 ...
	 public P get() {
	 	 return (P)module0107_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public P call() throws Exception {
	 	 return (P)module0107_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
