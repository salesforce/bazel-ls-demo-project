...
public abstract class Foo2<Y> extends module2106_public_tests_unittests.a.Foo0<Y> implements module2106_public_tests_unittests.a.IFoo2<Y> {
	 ...
	 public Y get() {
	 	 return (Y)module2106_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public Y call() throws Exception {
	 	 return (Y)module2106_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
