...
public abstract class Foo1<X> extends module1870.a.Foo0<X> implements module1870.a.IFoo1<X> {
	 ...
	 public X get() {
	 	 return (X)module1870.a.Foo0.getInstance().get();
	 }
	 ...
	 public X call() throws Exception {
	 	 return (X)module1870.a.Foo0.getInstance().call();
	 }
}
