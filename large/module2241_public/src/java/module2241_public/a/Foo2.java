...
public abstract class Foo2<M> extends module2241_public.a.Foo0<M> implements module2241_public.a.IFoo2<M> {
	 ...
	 public M get() {
	 	 return (M)module2241_public.a.Foo0.getInstance().get();
	 }
	 ...
	 public M call() throws Exception {
	 	 return (M)module2241_public.a.Foo0.getInstance().call();
	 }
}
