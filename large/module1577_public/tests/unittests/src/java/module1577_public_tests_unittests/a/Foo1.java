...
public abstract class Foo1<T> extends module1577_public_tests_unittests.a.Foo0<T> implements module1577_public_tests_unittests.a.IFoo1<T> {
	 ...
	 public T get() {
	 	 return (T)module1577_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public T call() throws Exception {
	 	 return (T)module1577_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
