...
public abstract class Foo2<Y> extends module1529_public_tests_unittests.a.Foo0<Y> implements module1529_public_tests_unittests.a.IFoo2<Y> {
	 ...
	 public Y get() {
	 	 return (Y)module1529_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public Y call() throws Exception {
	 	 return (Y)module1529_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
