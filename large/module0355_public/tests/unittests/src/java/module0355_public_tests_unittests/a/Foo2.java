...
public abstract class Foo2<Q> extends module0355_public_tests_unittests.a.Foo0<Q> implements module0355_public_tests_unittests.a.IFoo2<Q> {
	 ...
	 public Q get() {
	 	 return (Q)module0355_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public Q call() throws Exception {
	 	 return (Q)module0355_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
