...
public abstract class Foo2<I> extends module0884_public_tests_unittests.a.Foo0<I> implements module0884_public_tests_unittests.a.IFoo2<I> {
	 ...
	 public I get() {
	 	 return (I)module0884_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public I call() throws Exception {
	 	 return (I)module0884_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
