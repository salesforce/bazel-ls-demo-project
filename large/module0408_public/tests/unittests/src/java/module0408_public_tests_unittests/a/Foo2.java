...
public abstract class Foo2<A> extends module0408_public_tests_unittests.a.Foo0<A> implements module0408_public_tests_unittests.a.IFoo2<A> {
	 ...
	 public A get() {
	 	 return (A)module0408_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public A call() throws Exception {
	 	 return (A)module0408_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
