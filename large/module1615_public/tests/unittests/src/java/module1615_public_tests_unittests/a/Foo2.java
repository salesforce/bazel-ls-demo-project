...
public abstract class Foo2<M> extends module1615_public_tests_unittests.a.Foo0<M> implements module1615_public_tests_unittests.a.IFoo2<M> {
	 ...
	 public M get() {
	 	 return (M)module1615_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public M call() throws Exception {
	 	 return (M)module1615_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
