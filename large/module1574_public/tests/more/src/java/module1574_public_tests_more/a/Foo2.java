...
public abstract class Foo2<K> extends module1574_public_tests_more.a.Foo0<K> implements module1574_public_tests_more.a.IFoo2<K> {
	 ...
	 public K get() {
	 	 return (K)module1574_public_tests_more.a.Foo0.getInstance().get();
	 }
	 ...
	 public K call() throws Exception {
	 	 return (K)module1574_public_tests_more.a.Foo0.getInstance().call();
	 }
}
