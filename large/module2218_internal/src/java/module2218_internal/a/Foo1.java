...
public abstract class Foo1<X> extends module2218_internal.a.Foo0<X> implements module2218_internal.a.IFoo1<X> {
	 ...
	 public X get() {
	 	 return (X)module2218_internal.a.Foo0.getInstance().get();
	 }
	 ...
	 public X call() throws Exception {
	 	 return (X)module2218_internal.a.Foo0.getInstance().call();
	 }
}
