...
public abstract class Foo1<T> extends module2081_public_tests_more.a.Foo0<T> implements module2081_public_tests_more.a.IFoo1<T> {
	 ...
	 public T get() {
	 	 return (T)module2081_public_tests_more.a.Foo0.getInstance().get();
	 }
	 ...
	 public T call() throws Exception {
	 	 return (T)module2081_public_tests_more.a.Foo0.getInstance().call();
	 }
}
