...
public abstract class Foo2<A> extends module2151_public_tests_unittests.a.Foo0<A> implements module2151_public_tests_unittests.a.IFoo2<A> {
	 ...
	 public A get() {
	 	 return (A)module2151_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public A call() throws Exception {
	 	 return (A)module2151_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
