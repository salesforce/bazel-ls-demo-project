...
public abstract class Foo1<V> extends module2046_public_tests_more.a.Foo0<V> implements module2046_public_tests_more.a.IFoo1<V> {
	 ...
	 public V get() {
	 	 return (V)module2046_public_tests_more.a.Foo0.getInstance().get();
	 }
	 ...
	 public V call() throws Exception {
	 	 return (V)module2046_public_tests_more.a.Foo0.getInstance().call();
	 }
}
