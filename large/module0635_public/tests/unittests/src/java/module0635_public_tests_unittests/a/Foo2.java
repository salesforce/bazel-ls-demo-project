...
public abstract class Foo2<C> extends module0635_public_tests_unittests.a.Foo0<C> implements module0635_public_tests_unittests.a.IFoo2<C> {
	 ...
	 public C get() {
	 	 return (C)module0635_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public C call() throws Exception {
	 	 return (C)module0635_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
