...
public abstract class Foo1<V> extends module1542_public_tests_unittests.a.Foo0<V> implements module1542_public_tests_unittests.a.IFoo1<V> {
	 ...
	 public V get() {
	 	 return (V)module1542_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public V call() throws Exception {
	 	 return (V)module1542_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
