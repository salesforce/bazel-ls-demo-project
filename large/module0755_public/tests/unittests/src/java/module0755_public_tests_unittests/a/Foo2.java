...
public abstract class Foo2<K> extends module0755_public_tests_unittests.a.Foo0<K> implements module0755_public_tests_unittests.a.IFoo2<K> {
	 ...
	 public K get() {
	 	 return (K)module0755_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public K call() throws Exception {
	 	 return (K)module0755_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
