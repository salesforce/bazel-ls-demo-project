...
public abstract class Foo2<S> extends module1390_public.a.Foo0<S> implements module1390_public.a.IFoo2<S> {
	 ...
	 public S get() {
	 	 return (S)module1390_public.a.Foo0.getInstance().get();
	 }
	 ...
	 public S call() throws Exception {
	 	 return (S)module1390_public.a.Foo0.getInstance().call();
	 }
}
