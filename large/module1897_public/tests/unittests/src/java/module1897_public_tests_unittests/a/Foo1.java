...
public abstract class Foo1<F> extends module1897_public_tests_unittests.a.Foo0<F> implements module1897_public_tests_unittests.a.IFoo1<F> {
	 ...
	 public F get() {
	 	 return (F)module1897_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public F call() throws Exception {
	 	 return (F)module1897_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
