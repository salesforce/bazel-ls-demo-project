...
public abstract class Foo2<K> extends module1968_public_tests_unittests.a.Foo0<K> implements module1968_public_tests_unittests.a.IFoo2<K> {
	 ...
	 public K get() {
	 	 return (K)module1968_public_tests_unittests.a.Foo0.getInstance().get();
	 }
	 ...
	 public K call() throws Exception {
	 	 return (K)module1968_public_tests_unittests.a.Foo0.getInstance().call();
	 }
}
